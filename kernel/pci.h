/* pci.h — PCI bus enumeration (Phase 7a.1)
 *
 ...
 *
 * This is strictly read-only: no device configuration, no IRQ routing,
 * no BAR writing. Future drivers use the pci_device table to discover
 * hardware.
 */
#ifndef LUMAOS_PCI_H
#define LUMAOS_PCI_H
